...
namespace SecretSanta.Web.Data
{
    ...
    {
        public static List<GroupViewModel> Groups { get; } = new List<GroupViewModel>
        {
            new GroupViewModel { Id = 1, Name = "GoonSquad" },
            new GroupViewModel { Id = 2, Name = "Rodents Of Unusual Size" },
        };

        public static List<GiftViewModel> Gifts { get; } = new List<GiftViewModel>
        {
        ...
        public static List<UserViewModel> Users { get; } = new List<UserViewModel>
        {
